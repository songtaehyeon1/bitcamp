...
<div class = "container">
	...
	<div id = "mypage_save_main">
		...
		<div class = "mypage_main_div">
			...
			<div class = "mypage_main_div_div">
				...
				<div><span class = "mypage_font">${topList.orderTot}원(${topList.orderCnt}회)</span></div>
			</div>
		</div>
	</div>
	<div id = "mypage_order_main">
		...
		<div id = "mypage_order_div">
			...
			<div class = "mypage_center"><div><span class = "mypage_font">배송중</span></div><div><span><a href = "/bitcamp/mypageOrderHistory?delivery_status=배송중">${topList.delivery_ship_pro}</a></span></div></div>
			<div class = "mypage_center"><div><span class = "mypage_font">배송완료</span></div><div><span><a href = "/bitcamp/mypageOrderHistory?delivery_status=배송완료">${topList.delivery_com}</a></span></div></div>
			<div>
				<ul id = "mypage_order_ul">
					<li><span class = "mypage_font">취소&emsp;:&emsp;</span><span class = "mypage_font"><a href = "/bitcamp/mypageOrderHistory?delivery_status=취소">${topList.delivery_cancel}</a></span></li>
					<li><span class = "mypage_font">반품&emsp;:&emsp;</span><span class = "mypage_font"><a href = "/bitcamp/mypageOrderHistory?delivery_status=반품">${topList.delivery_return}</a></span></li>
				</ul>
			</div>
		</div>
	</div>
	<div id = "mypage_menu">
		...
		<div class = "mypage_menu_div" onclick = "location.href = '/bitcamp/mypageWishList';">
			<span>WISHLIST</span><span>관심상품</span><hr>
			<span class = "mypage_font">관심상품으로 등록하신 상품의 목록을 보여드립니다.</span>
		</div>
		<!-- <div class = "mypage_menu_div" onclick = "location.href = '/bitcamp/mypageMileage';">
