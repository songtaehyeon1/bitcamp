			...
			<ul id="main-menu">
				...
				<li>
					<div id="cart-box">
						...
						<span class="badge badge-pill badge-light blink bounce">0</span>
					</div>
				</li>
			</ul>
			<div id="center-nav">
				<ul>
					<li data-toggle="tooltip" title="맨위로"><a href="#main-top"><i class="fas fa-angle-up fa-2x"></i></a></li>
					<li data-toggle="tooltip" data-placement="left" title="맨밑으로"><a href="#footer"><i class="fas fa-angle-down fa-2x"></i></a></li>
