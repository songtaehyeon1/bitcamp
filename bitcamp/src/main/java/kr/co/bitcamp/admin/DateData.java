...
public class DateData {
	...
	String db_startDate = "";
	String db_endDate = "";	
	TotalVO[] order_data_arr = new TotalVO[4];
	...
	public TotalVO[] getOrder_data_arr() {
		return order_data_arr;
	}
	public void setOrder_data_arr(TotalVO[] order_data_arr) {
		this.order_data_arr = order_data_arr;
	}
	...
	public DateData(String year, String month, String date, String value, TotalVO[] order_data_arr) {
